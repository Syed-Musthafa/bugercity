    ...
    <View style={styles.container}>
        ...
        >
            ...
            <View style={styles.tip}>
                <Text style={styles.tipText}>A text message  with 4-digit verification code was just sent to xxx xxx xx27</Text>
            </View>
            <View style={styles.input}>
                <Input icon={icons.lock} placeholder="Mobile Number" password/>
