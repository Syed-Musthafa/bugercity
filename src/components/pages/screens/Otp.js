    ...
    <View style={styles.container}>
        ...
        >
            ...
            <View style={styles.tip}>
                <Text style={styles.tipText}>For your security, a one time password has been sent to  your email, please enter it below to continue</Text>
            </View>
            <View style={styles.input}>
                <Input icon={icons.lock} placeholder="OTP" password/>
